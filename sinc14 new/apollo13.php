...
<style type="text/css" media="all">
@import url("css/maintenance-page.css");
							...
							<a href="credits.php">CREDITS</a></li>
								...
								<li><a class="navlink" href="details.php">Registration</a>
									<div class="drop" id="dropdown-1">
										...
										<div class="col-3">
											...
											<p>
												<strong>REGISTRATIONS OPEN</strong> <br>Registrations SINC
												2k14 are open.
											</p>
								...
								<li><a class="navlink" href="talks.php">SEDS TALKS</a>
									<div class="drop" id="dropdown-4">
										<div class="col-1">
											<ul class="level-2">
												<li><a href="YSRajan.php" title=""><b>Talk 1</b></a></li>
												<li><a href="prajval.php" title=""><b>Talk 2</b></a></li>
												<li><a href="avinash.php" title=""><b>Talk 3</b></a></li>

												<li><a href="kk.php" title=""><b>Talk 4</b></a></li>
												<li><a href="Srinivas_Laxman.php" title=""><b>Talk 5</b></a></li>
											...
											<div class="menu-photo-2">
												<ul id="rotator">
													<li><a class="name" href="kk.php"><img
															src="images/Guest pics/kunhikrishnan.jpg" />Dr.P Kunhi
															Krishnan</a></li>
			...
			<section id="main" role="main" class="grid_13 boxsize clearfix">
				...
				<div class="panel-display panel-home clearfix" id="front">
					...
					<div class="panel-row panel-articles">
						<div id="home-article-left" class="panel-panel panel-article">
							<div class="panel-pane pane-node">
								<!-- left -->


								<div class="content">
									<img class="center" src="images/apollo.jpg"
										style="width: 700px;" />
						...
						<div id="home-article-right" class="panel-panel panel-article"></div>
							
							<div class="panel-pane pane-node"></div>
						</div>
					</div>
					...
					<p>Apollo 13 was the seventh manned mission in the American Apollo
						space program and the third intended to land on the Moon. The
						craft was launched on April 11, 1970, at 13:13 CST from the
						Kennedy Space Center, Florida, but the lunar landing was aborted
						after an oxygen tank exploded two days later, crippling the
						Service Module (SM) upon which the Command Module (CM) depended.
						Despite great hardship caused by limited power, loss of cabin
						heat, shortage of potable water, and the critical need to jury-rig
						the carbon dioxide removal system, the crew returned safely to
						Earth on April 17.</p>


					<h1>The Movie</h1>
					<p>Three astronauts must devise a strategy to return to Earth
						safely after their spacecraft undergoes massive internal damage.</p>
					<p>Released in the United States on June 30, 1995, Apollo 13
						garnered critical acclaim and was nominated for many awards,
						including nine Academy Awards (winning for Best Film Editing and
						Best Sound).In total, the film grossed over $355 million worldwide
						during its theatrical releases.</p>
					<h4>Grab your Tickets now for Apollo 13 to be screened at
						SEDS-SASTRA Talkies.</h4>
				...
				<div class="region region-sidebar-second">
					<section id="block-socmed-btns-social-media-icons"
						...
						<section id="block-socmed-btns-social-media-icons"
							...
							<img src="images/app.jpg" style="width: 200px;" />

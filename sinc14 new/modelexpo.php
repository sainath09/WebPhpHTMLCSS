...
<div class="panel-row panel-articles">
 ...
 <div id="home-article-" class="panel-panel panel-article"><div class="panel-pane pane-node" >
        ...
        <h2>“Any sufficiently advanced technology is indistinguishable from magic.” </h2>
        <h3 class="pane-title-right">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- Arthur C. Clarke</h3>
        <hr>
        
       <h4>Students are invited to participate in the model exhibition cum competition.
       </h4>
       
        <h4> Breaking the barriers between the past and the future, Exhibition is an endeavour to bridge the gap between technologists and common man. Seize this opportunity to showcase your innovative ideas. This is the event exclusively designed to kindle the minds of neighbouring school youths and to encourage participation out of the school arena, so as to discover the essence of innovation from every nook and cranny of the region. It is a platform to empower students’ imagination to real.</h4>

<h3>Rules and Regulations:</h3>
<h4>•	<b>Team Specification:</b> A team consists of a maximum of 3 participants <br>
•	<b>Eligibility:</b> 6th Std to 12th Std (Schools); All College students<br>
•	<b><u>Separate category of judging for school students & college students</u></b> <br>
•	<b>Categories of scientific exhibits:</b> Working and non-working models<br>
•	You will be allowed to explain your model for 10 min<br>

•	Judgement on the basis of creativity, innovation and implementation<br>
•  Registration for the event can be done on the spot

</h4>
<h3>Suggested Topics: </h3>
<h4>•	Building a miniature telescope/gyroscope/sundial<br>
•	Models of space shuttle/rockets<br>
•	Making your own comet model<br>
•	Viewing sunspots through pinhole camera
</h4>

<br><br>
 
<h2>*Models need not be restricted to the above topics and it can be anything creative and innovative related to space science & technology.</h3> 
...
<img  src="images/events/modelexpo.jpg" style="width: 300px;" />
 </section></div></aside>

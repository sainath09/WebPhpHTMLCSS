...
<!--
ul#rotator {list-style:none;margin:0px;padding:0px;width:200px;height:200px;overflow:hidden;}
ul#rotator li,
ul#rotator li a,
ul#rotator li img,
ul#rotator li a img {width:200px;height:200px;margin:0px;padding:0px;border:none;}
--> 
</style>
...
<div class="panel-row panel-articles">
 ...
 <div id="home-article-" class="panel-panel panel-article"><div class="panel-pane pane-node" >
       ...
       <img class="center" src="images/temple.jpg" style="width: 700px;" />
        <h3 class="pane-title">BRIHADEESHWARA TEMPLE,TANJORE</h3>
        <hr> <!-- right -->
        <h4>Tanjore Brihadeeswara Temple is one of the best temples in South India, built by Chola emperor Raja Raja I (985-1013 AD). This is the chola dynasty's finest contribution to Dravidian art. The construction is unique : the vimanam, known as Dakshina Meru, soars high while the gopuram remains stunted. The 64.8 metre-tall, 14-tier and pyramid-shaped vimanam rises from a square base and is topped by a huge monolithic cupola weighing 81.3 tonnes.
        <br><br>
        <b> The shadow of the cupola never falls on the ground.</b></h4>
 
 <br>
 <h3 class="pane-title">Special Attributes of Tanjore Big Temple</h3>
 <hr>
 <h4>The most interesting part of this temple is the shadow of the temple, which surprisingly never falls on the ground at noon. The Brihadeshwara Temple is one of the tallest temples in the world and is so designed that the viman does not cast a shadow at noon during any part of the year.</h4>
 
 <br>
 <h2>Tanjore Brihadeeswara Temple (also called Big Temple) have been declared as UNESCO World Heritage Site.</h2>
 <br>
 <hr>
 
 <h2>SREE RANGANATHASWAMI TEMPLE,TRICHY</h2>
 <h4>Srirangam is the foremost of the eight self-manifested shrines (Swayam Vyakta Kshetras) of Lord Vishnu . It is also considered the first, foremost and the most important of the 108 main Vishnu temples (Divyadesams). This temple is also known as Thiruvaranga Tirupati, Periyakoil, Bhoologa Vaikundam, Bhogamandabam. In the Vaishnava parlance the term "KOIL" signifies this temple only. The temple is enormous in size. The temple complex is 156 acres in extent. It has seven prakaras or enclosures. These enclosures are formed by thick and huge rampart walls which run round the sanctum. There are 21 magnificent towers in all prakaras providing a unique sight to any visitor. this temple lies on an islet formed by the twin rivers Cauvery and Coleroon.</h4>
...
<div class="clear"></div>
  ...
  <h3>IMAGES OF THE 'BIG' TEMPLE</h3>
  <img src="images/tem.jpg" style="width: 300px; height: 500px;" /> 

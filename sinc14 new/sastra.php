...
<div class="panel-row panel-articles">
 ...
 <div id="home-article-" class="panel-panel panel-article"><div class="panel-pane pane-node" >
        ...
        <h1 class="pane-title">SASTRA University</h1> <!-- right -->
...
<p>SASTRA offers various undergraduate and post graduate courses in Engineering, Science, Education, Management, Law and Arts besides various Doctoral programmes and has state-of-the-art laboratories, a well stocked library and one of the best computing facilities. With an ideal teacher-taught ratio, we strive for academic excellence through personalized attention. The mechanism established to support and monitor the student's progress assure success and satisfaction.
</p>
<p>Since its inception SASTRA has achieved national standing in terms of academic performance, co-curricular and extra-curricular activities and also in its growth and commitment to social service. The standard of excellence of our courses is reflected in the grades awarded to us by the National Assessment and Accreditation Council and in the success of our students in industry and academia, both in India & abroad. 
</p>
<p>SASTRA shapes its students' future by fostering a teamwork approach to instruction, encouraging interaction with faculty, providing access to high tech information, motivating them to develop new ideas and concepts, taking personal interest in students' career development and preparing them for success. 
</p>
<p>SASTRA has an ethos of its own, different from others. At a time when altruistic ideals and civic interests seem to have given way to power goals and heightened interest in materialism, SASTRA presents a holistic approach to personal and professional growth.

</p>
<p>SASTRA moulds its students in such a way that their endeavors and interests transcend traditional boundaries. They do not seek to maintain status quo nor settle for observing change; they rather hope to be powerful instruments of change using their dynamic verve to make their contributions to the world.</p>

<p><a class="arrow-green" href="http://www.sastra.edu">View  SASTRA WEBSITE</a></p>

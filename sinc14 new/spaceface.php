...
<div class="panel-row panel-articles">
  <div id="home-article-" class="panel-panel panel-article"><div class="panel-pane pane-node" >
  
        <h2 class="pane-title"></h2>  <!-- -left -->
 ...
 <div id="home-article-" class="panel-panel panel-article"><div class="panel-pane pane-node" >
        ...
        <h2>“I do not paint a portrait to look like the subject,
 rather does the person grow to look like his portrait”
         </h2>
        <h3 class="pane-title-right">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-Salvador Dali</h3>
        <hr>
        
       <h2>Art is euphoria!!!</h2>
       
       
       <h4>From time immemorial, face and body art have been ways for people to acquire the powers of the creature they have been painted to resemble.
       </h4>
       
        <h4> In this event the participants are made to ponder the possibilities of existence of extraterrestrial life.</h4>
<h4>There is no direct proof for any life beyond Earth but the universe is home to a lot of stars which harbor many planets. To dream is to believe; to create is to succeed.

</h4>

<h2>Get Ready to paint & appear Weird!!!</h2>

<h3>Guidelines:</h3>
<h4>•A team comprises of two members<br>
•	You have to paint your partner’s face look like an alien<br>
•	Put your imaginations to work and bring aliens to earth with the stroke of your brush<br>
•	The most bizarre/creative alien will remain fittest during the competition.<br>
 

</h4>

<h3>Eligiblity:</h3> <h4>In order to be eligible, you must be a registered participant</h4>
<h3>Rule & Regulations: </h3>
<h4>•	All competitors must check in at the competition desk 15 minutes prior to the start of the competition<br>
•	Competitors will be given 1 hr to complete the design<br>
•	JUDGING will take place immediately after the time limit given. The judging categories are: </h4>
	<h4>1)Originality</h4>
	<h4>2)Creativity</h4>
	<h4>3)Design technique used</h4>
<h4>•	All the necessary materials will be given. Only the given materials should be used by participants<br> 
•	Competitors may not use photos or drawings to refer to while painting. All designs will be painted free-hand<br>
•	Judges’ decision remains final
<br></h4>
...
<br>
<h2>So add just an eye or cheek highlight or transform your face for the hour & become a work of art!!!</h2>
 <br>
...
<div class="clear"></div>
   ...
   <aside id="sidebar-second" role="complementary" class="grid_7 boxsize alpha omega sidebar clearfix">			
      <div class="region region-sidebar-second">
  <section id="block-socmed-btns-social-media-icons" class="block block-socmed-btns">
<img  src="images/events/space face.jpg" style="width: 300px;" />
 </section></div></aside>

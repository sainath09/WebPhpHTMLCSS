					...
					<div class="panel-row panel-articles">
						<div id="home-article" class="panel-panel panel-article">
							<div class="panel-pane pane-node">
								...
								<h2 class="pane-title">SASTRA-Shanmugha Arts, Science,
									Technology & Research Academy</h2>
										...
										<div
											...
											<div class="field-items">
												<div class="field-item even" property="content:encoded">
													...
													<form action="vdetails.php" method="POST">
														<fieldset>
															...
															<form name="regis">
																...
																<div>
																	<input type="text" name="email" id="email"
																		placeholder="Email" / onChange="return checkmail()"
																		required />
																</div>
																<div>
																	<input type="text" name="mobile" id="mno"
																		placeholder="Mobile Number" maxlength="10"
																		onkeypress="return mobile(event)"
																		onChange="return Validate_contact()" required />
																</div>
																<div>
																	<input type="text" name="college" id="noc"
																		placeholder="Name of the Institution" required />
																</div>
																<div>
																	<input type="text" name="registno" id="rno"
																		placeholder="Institution ID/Registration number"
																		required />
																</div>
																<div>
																...
																<select type="text" name="member1" id="mem" required>


																	<option value="" selected>--SELECT--</option>
																	<option value="1">SEDS-MEMBER</option>
																	<option value="2">NON-SEDS MEMBER</option>
																	<option value="3">Academicians</option>
																	<option value="4">Corporates</option>
																	<option value="5">Overseas Delegates</option>

																</select>

																<div>
																	<input type="text" name="chaptername" id="cname"
																		placeholder="SEDS-Chapter Name" />
																</div>
																<div>

																	<input type="text" name="cid" id="fno"
																		placeholder="SEDS-Member ID/Form Number" />
																</div>

																<div>
																	<!----<div class="small">Area of Interest</div> ----->
																	<textarea name="address" id="afc"
																		placeholder="Permanent Address" required></textarea>
																</div>

																<div>
																	<input type="text" name="w" id="w"
																		placeholder="Workshops / CONFERENCE" required />
																</div>
													...
													<p>
														<a class="arrow-green" href="details.php">View

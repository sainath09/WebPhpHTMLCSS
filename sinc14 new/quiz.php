...
<head>
  ...
  <title> :: INTERSTELLAR WIZARDRY ::</title>
...
<div class="panel-row panel-articles">
 ...
 <div id="home-article-" class="panel-panel panel-article"><div class="panel-pane pane-node" >
        ...
        <h3 class="pane-title"></h3> <!-- right -->
    <!--    <h4>While staying at their divorced father's home while he is away at work and Lisa is asleep, the boys discover 
       an old clockwork-driven space-themed board game called <b>"Zathura" </b>in the basement. The two begin to play the game, 
       the goal to be the first to reach the final space named Zathura. During each turn, the game provides a card with instructions, 
       but the two quickly realize the cards affect reality, starting with a meteor shower. 
       They soon discover the house is floating on a small rock in outer space. 
       ...
       The brothers realize that the only way to end the game and hopefully return to Earth is to reach the end space of Zathura.</h4>
       
        <hr> -->
        <h4>This event will set the stage on fire with an unconventional space quiz battle between the space brains from across the country.</h4>
<h4>Endurance is all that matters & only the best will survive.</h4>


<h3>Guidelines:</h3>
<h4>•	Test of your knowledge about space<br>
•	There will be two stages : preliminary and finals<br>
•	The prelims will be in written, based on the questions flashed on the screen<br>
•	Top six teams will be selected for finals<br>
•	Finals will have three to four rounds
...
<h4>•	Maximum of 3 members per team<br>
•	<b>Eligibility: </b>School students (8th grade & above) and college students<br>
•	Use of mobile phone or Internet will lead to disqualification<br>
...
<img  src="images/events/Space_Wizard.jpg" style="width: 300px;" />
 </section></div></aside>
